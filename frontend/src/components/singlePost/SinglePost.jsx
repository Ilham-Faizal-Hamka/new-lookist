...
export default function SinglePost() {
  ...
  useEffect(() => {
    const getPost = async () => {
      const res = await axios.get("https://new-lookist-api.vercel.app/api/posts/" + path);
      setPost(res.data);
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`https://new-lookist-api.vercel.app/api/posts/${post._id}`, {
  ...
  const handleUpdate = async () => {
    try {
      await axios.put(`https://new-lookist-api.vercel.app/api/posts/${post._id}`, {
